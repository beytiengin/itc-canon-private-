...
| **Karar 11 (HMDK Stuttgart Bağlam, 13 madde)** | Ana repoda Karar 11 = Transmisyon Mimarisi (BE × FKA Eş Eğitmenlik, Spine §3.13) — **farklı içerik** | Workshop sohbeti Karar 11'in 13 maddesi ana Decision Log'a girmedi. Sadece tarih maddesi (25-29 Ocak 2027) Brief v2.1 Milestone 2.7'de işlendi (paket içinde Karar 15 = HMDK tarih düzeltmesi). **13 maddenin tamamı için ana Decision Log'a Karar 17 olarak ayrı yedirme bekleniyor.** |
...
### Berlin Eylül 2026 Pilotu — Açık Karar

Bu Workshop Spine v1.2 Berlin Chubbuck Studio Eylül 2026 pilotunu A2'nin **ilk gerçek pilotu** olarak konumlandırır (HMDK Ocak 2027 ikinci uygulama). Ancak Berlin pilotu ana repoda (ana Spine, Brief v2.2, Decision Log) **henüz formal karar olarak yedirilmedi**. Karar 16 metni içinde "gelecek karar: Berlin Chubbuck Studio yapısı (Auditor + Participant + Advance)" olarak işaretli. HMDK 13 madde + Berlin Eylül 2026 paketi ayrı bir oturumda büyük paket olarak yedirilecek; o paket sonrası bu Workshop Spine'a §9 Brief v2 çelişkisi notunu da güncellemek gerek.
...
- **Yolculuk:** Her oyuncuya bire bir Modül III yolculuğu. **Sahnede grup tanıklığında**, çift geri bildirim mimarisiyle (önce grup, oyuncu dinlenirken; sonra oyuncu kendi deneyimini paylaşır). Süre formata göre: 8 hafta formatında 90 dk, 5 gün intensive'de 75 dk slot.
...
### HMDK Stuttgart 25-29 Ocak 2027 (Karar 11 — alt-maddeler)
...
### Berlin Chubbuck Studio Eylül 2026

- Spesifik tarih (Eylül başı/ortası/sonu)? [Berlin koordinasyon]
- A2-Berlin-Variant detayları: 3 kademe (Auditor + Participant + Participant Advance) ücretlendirmesi
- Hamlet metin EN versiyonu (Workbook EN hazır mı, ne kadar)?
- Berlin paketi gönderim tarihi: Mayıs sonu hedef
...
**Brief v2 çelişkisi notu (güncel durum — 12 Mayıs 2026 ana repo yedirmeleri sonrası):** HMDK tarih hizalaması yapıldı — Brief v2.1 ile HMDK Stuttgart pilotu Faz 3 Milestone 3.1'den çıkarılıp Faz 2 Milestone 2.7'ye (25-29 Ocak 2027) taşındı. Brief v2.2 ile Karar 16 (FKA Eş Kurucu) ekosistem geneline yansıtıldı. **Hâlâ yapılması gereken:** Berlin Eylül 2026 pilotu Brief v2'ye hiç eklenmedi — ne Faz 1'de ne A2'nin ilk gerçek pilotu konumunda. Brief v2 → v2.3 revizyonu bekliyor (HMDK 13 madde detayı + Berlin Eylül 2026 entegrasyonu; ayrı paket olarak yedirilecek).
