# Decision Log Eklentisi — 12 Mayıs 2026 Workshop Geri Besleme Paketi

Bu dosya `decision-log.md`'nin **en üstüne** (Kararlar başlığının hemen altına, mevcut "8 Mayıs 2026 — Doğrular Çift Üçlü" kaydının üstüne) yapıştırılır. Dört kayıt birlikte, en yeni en üstte sırayla: Karar 14 → 13 → 12 → 11.

Not: Karar 15 (HMDK tarih düzeltmesi) Brief v2 güncellemesidir — Decision Log'a ayrı kayıt girmez, çünkü Spine'ı etkilemiyor. Sadece Brief v2.0 → v2.1 metnine işlenir.
...
*Decision Log'a yapıştırma sırası: Dört kayıt en üste (Kararlar başlığının hemen altına) sırayla — Karar 14 (en üstte) → 13 → 12 → 11. Mevcut "8 Mayıs 2026 — Doğrular Çift Üçlü" kaydının üstüne girer. Ayrıca "Son güncelleme: 12 Mayıs 2026" üst meta-veriye yazılır. "ÖNEMLİ TARİHLER" tablosuna iki satır eklenir: **12 Mayıs 2026 — Workshop geri besleme paketi (Karar 11–14)**, **12 Mayıs 2026 — Spine v1.6 yayımlandı**.*
